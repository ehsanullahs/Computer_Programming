...
def gen_scatter_chart(Utilize_energy, waste_emissions, Travel_for_business):

    # Create the x and y values of the data
    x_values = ['Utilize_energy', 'Waste Emissions', 'Travel_for_business']
    y_values = [Utilize_energy, waste_emissions, Travel_for_business]
...
def main():
    ...
    while True:
        ...
        if choice == '1':
            ...
            gen_scatter_chart(Utilize_energy, waste_emissions, Travel_for_business)
